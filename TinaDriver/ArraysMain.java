...
public class ArraysMain {
	...
	public static void main(String[] args) {
		...
		System.out.println(charArray[2]);	// output: $
		System.out.println(charArray[3]);	// output: {
		System.out.println(charArray[4]);	// output: J
		...
		System.out.println(charArray[cIndex]);	// output: h
		cIndex = 4;
		cValue = '*';
		charArray[cIndex] = cValue;
		System.out.println(charArray[cIndex]);	// output: *
		int var1 = 5;
		int var2 = 1934;
		int someOtherVar = -24;
		...
		System.out.println(anotherIntArray[0]);	// output: 5
